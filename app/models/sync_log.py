...
class SyncLog(Base):
    ...
    sync_type: Mapped[str] = mapped_column(String(32), nullable=False)  # full_poll / webhook / manual
    action: Mapped[str] = mapped_column(String(32), nullable=False)  # enroll / activate / deactivate / photo_upload / remove
